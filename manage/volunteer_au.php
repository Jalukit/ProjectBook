...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <a href="authorities.php" class="nav-link ">
          ...
          <li class="nav-item">
            <a href="volunteer_au.php" class="nav-link active">
              <i class="nav-icon fas fa-edit"></i>
              <p>
              ตรวจสอบกิจกรรม
              </p>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">แสดงข้อมูลสถิติการลงจิตอาสา </h3>
 ...
 ?>
                    ...
                    <td align="center" class="align-middle"><a href="student_au.php?id_p=<?php echo $result['id_p']?>"><button class="btn btn-info"><?php echo $result['items_total']?> คน <i class='fas fa-eye'></i></button></a></td>

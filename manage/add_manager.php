...
<head>
  ...
  <title>ระบบจัดการสารสนเทศ </title>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
                ...
                <button type="button" class="btn btn-info float-right" onclick="window.location='manager.php'"><i class="fa fa-arrow-left"></i> ย้อนกลับ</button>

...
echo"<script>window.location='reply_user.php?id_ques=$_GET[id_ques]'</script>";	
exit();
}else{
...
?>
						...
						/*	if(@$_SESSION['id_stu']==""){
							  ...
							  ?>
 <form action="reply_user.php?id_ques=<?php echo $_GET["id_ques"];?>&Action=Save" method="post" name="frmMain" id="frmMain" onSubmit="return Check_txt()">
...
?>
     ...
     <input name="txtname" type="text" id="txtname" value="" require>
                                    </td>
		                          </tr>
		                        </table><br>
			                    <center>

...
<div class="wrapper">
     ...
     <!-- SidebarSearch Form 
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="volunteer_bi.php" class="nav-link active">
              <i class="nav-icon fas fa-edit"></i>
              <p>
              ตรวจสอบกิจกรรม
              </p>
 ...
 ?>
                    ...
                    <td align="center" class="align-middle"><a href="student_bi.php?id_p=<?php echo $result['id_p']?>"><button class="btn btn-info"><?php echo $result['items_total']?> คน <i class='fas fa-eye'></i></button></a></td>

...
$sql="insert into news (name_n,detail_n) values
('".$_POST['name_n']."','".$_POST['detail_n']."')";
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">เพิ่มข้อมูลข่าวประชาสัมพันธ์</h3>
  ...
  <form id="form1" name="form1" method="post" action="" onsubmit="return check_text()" enctype="multipart/form-data">
        ...
        <table width="550" border="0" align="center">
          <tr>
            ...
            <td align="left"><input name="name_n" class="form-control" type="text" id="name_n" size="50" required/>
           </td>
          </tr>
          <tr>
            <td align="left">รายละเอียดข่าว :</td>
            <td align="left"><textarea class="form-control" id="exampleFormControlTextarea1" name="detail_n" rows="3" required></textarea>
            </td>
          </tr>
          <tr>

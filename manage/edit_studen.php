  ...
  <form id="form1" name="form1" method="post" action="" onsubmit="return check_text()" enctype="multipart/form-data">
        ...
        <!--<tr>
          ...
          <tr>
           ...
           <td align="left"><input name="tel_stu" type="text" id="tel_stu" class="form-control" size="50" maxlength="10" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" value="<?php echo $row_Recordset1['tel_stu'];?>"/>
            </td>
          </tr>
          <tr>
            <td align="left">ชื่อผู้ใช้ :</td>
            <td align="left"><input name="user" type="text" id="user" size="50" class="form-control" value="<?php echo $row_Recordset1['user'];?>" />
           </td>
          </tr>
          <tr>
            <td align="left">รหัสผ่าน :</td>
            <td align="left"><input name="pass" type="password" id="pass" size="50" class="form-control" value="<?php echo $row_Recordset1['pass'];?>" />
           </td>
          </tr>
          <tr>

...
if(@$_POST['Submit']=="ยืนยัน"){
  ...
  name_n='".$_POST['name_n']."',
  detail_n='".$_POST['detail_n']."'
 WHERE id_n='".$_POST['id_n']."'";                  
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>จัดการข้อมูลข้อมูลข่าวประชาสัมพันธ์</h1>
          </div>
          <div class="col-sm-6">
         
                <button type="button" class="btn btn-info float-right" onclick="window.location='news_bi.php'"><i class="fa fa-arrow-left"></i> ย้อนกลับ</button>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">แก้ไขข้อมูลข่าวประชาสัมพันธ์</h3>
  ...
  <form id="form1" name="form1" method="post" action="" onsubmit="return check_text()" enctype="multipart/form-data">
        ...
        <table width="550" border="0" align="center">
          <tr>
            <td align="left">ข่าวประชาสัมพันธ์ :</td>
            <td align="left"><input name="name_n" class="form-control" type="text" id="name_n" size="50" value="<?php echo $row_Recordset1['name_n'];?>" />
           </td>
          </tr>
          <tr>
            <td align="left">รายละเอียดข่าว :</td>
            <td align="left"><textarea class="form-control" id="exampleFormControlTextarea1" name="detail_n" rows="3" ><?php echo $row_Recordset1['detail_n'];?></textarea>
            </td>
          </tr>
          <tr>
            <td colspan="2" align="center"><br>
            <input type="hidden" name="id_n" value="<?php echo $row_Recordset1['id_n']; ?>" />

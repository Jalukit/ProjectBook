...
<!-- SidebarSearch Form 
     ...
     <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="news_bi.php" class="nav-link active">
              <i class="nav-icon fas fa-edit"></i>
              <p>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>จัดการข้อมูลข่าวประชาสัมพันธ์</h1>
          </div>
          <div class="col-sm-6">
          <?php
if (@$_SESSION['status']!="3") {
  echo "";
         ...
         ?>
                <button type="button" class="btn btn-info float-right" onclick="window.location='add_news.php'"><i class="fas fa-user-plus"></i> เพิ่มข้อมูล</button>
<?php } ?>    
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">แสดงข้อมูลข่าวประชาสัมพันธ์</h3>
          ...
          <td ><div align="center">เวลาประกาศข่าว<div></td>
    ...
    include "connect.php";
		...
		?>        
                  <tr>
                    ...
                    <td align="center" class="align-middle"><?php echo $result['detail_n']?></td>
                    <td align="center" class="align-middle"><?php echo $result['date_n']?></td>
                    <td align="center" class="align-middle"><a href='edit_news.php?id_n=<?php echo $result['id_n']?>'><i class='fas fa-user-edit' style='font-size:48px;color:blue'></i></a></td>
                    <td align="center" class="align-middle"><a href='delte_news.php?id_n=<?php echo $result['id_n']?>' onclick="return confirm('คุณต้องการที่จะลบข้อมูลรายการนี้ ใช่หรือไม่ ???');"><i class='fas fa-user-minus' style='font-size:48px;color:red'></i></a></td>

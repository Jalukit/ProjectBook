...
if ($_SESSION['status']!="1") {
  echo "";
         ...
         ?> 
                <button type="button" class="btn btn-info float-right" onclick="window.location='add_officer.php'"><i class="fas fa-user-plus"></i> เพิ่มข้อมูล</button>
<?php } ?>     
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">แสดงข้อมูลเจ้าหน้าที่ กยศ. </h3>
    ...
    include "connect.php";
      ...
      ?>
                    ...
                    <td align="center" class="align-middle"><a href='edit_officer.php?per_id=<?php echo $result['per_id']?>'><i class='fas fa-user-edit' style='font-size:48px;color:blue'></i></a></td>

  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
                ...
                <button type="button" class="btn btn-info float-right" onclick="window.location='add_admin.php'"><i class="fas fa-user-plus"></i> เพิ่มข้อมูล</button>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">แสดงข้อมูลผู้ดูแลระบบ </h3>
    ...
    include "connect.php";
      ...
      ?>
                    ...
                    <td align="center" class="align-middle"><a href='edit_add.php?per_id=<?php echo $result['per_id']?>'><i class='fas fa-user-edit' style='font-size:48px;color:blue'></i></a></td>

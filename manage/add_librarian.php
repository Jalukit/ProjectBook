...
copy($_FILES["profile"]["tmp_name"],"profile/".$file);
$profile=$_FILES["profile"]["name"];
$sql="insert into personnel (profile,per_perfix,per_name,per_lastname,username,password,status) values
('$profile','".$_POST['per_perfix']."','".$_POST['per_name']."','".$_POST['per_lastname']."','".$_POST['username']."','".$_POST['password']."','".$_POST['status']."')";
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
                ...
                <button type="button" class="btn btn-info float-right" onclick="window.location='librarian.php'"><i class="fa fa-arrow-left"></i> ย้อนกลับ</button>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">เพิ่มข้อมูลบรรณารักษ์ </h3>
  ...
  <form id="form1" name="form1" method="post" action="" onsubmit="return check_text()" enctype="multipart/form-data">
        ...
        <tr>
          ...
          <tr>
            ...
            <select name="per_perfix" id="per_perfix" class="form-control" required>
          ...
          <tr>
            ...
            <td align="left"><input name="per_name" class="form-control" type="text" id="per_name" size="50" required/>
           </td>
          </tr>
          <tr>
            <td align="left">สกุล :</td>
            <td align="left"><input name="per_lastname" class="form-control" type="text" id="per_lastname" size="50" required/>
            </td>
          </tr>
          <tr>
            <td align="left">ชื่อผู้ใช้ :</td>
           <td align="left"><input name="username" type="text" id="username" class="form-control" size="50" required/>
            </td>
          </tr>
          <tr>
            <td align="left">รหัสผ่าน :</td>
            <td align="left"><input name="password" type="password" id="password" size="50" class="form-control" required />
           </td>
          </tr>
           <tr>
            ...
            <select name="status" id="status" class="form-control" readonly>
              <option value="3">บรรณารักษ์</option>
            </select>
  			</td>
          </tr>
          <tr>

        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="librarian.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
...
if ($_SESSION['status']!="1") {
  echo "";
         ...
         ?>
                <button type="button" class="btn btn-info float-right" onclick="window.location='add_librarian.php'"><i class="fas fa-user-plus"></i> เพิ่มข้อมูล</button>
<?php } ?>  
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">แสดงข้อมูลบรรณารักษ์ </h3>
          ...
          <td ><div align="center">รูปประจำตัว<div></td>
    ...
    include "connect.php";
		...
		?>        
                  <tr>
                    ...
                    <td align="center" class="align-middle"><img src="profile/<?php echo $result['profile']?>" width="100" height="130" style="border-radius:15px;"></td>
                    <td align="center" class="align-middle"><?php echo $result['per_perfix']?><?php echo $result['per_name']?>&nbsp;&nbsp;<?php echo $result['per_lastname']?></td>
      ...
      ?>
                    ...
                    <td align="center" class="align-middle"><?php echo $result['username']?></td>
                    <td align="center" class="align-middle"><?php echo $result['password']?></td>
                    <td align="center" class="align-middle"><a href='edit_librarian.php?per_id=<?php echo $result['per_id']?>'><i class='fas fa-user-edit' style='font-size:48px;color:blue'></i></a></td>
                    <td align="center" class="align-middle"><a href='delte_pre.php?per_id=<?php echo $result['per_id']?>&status=<?php echo $result['status']?>' onclick="return confirm('คุณต้องการที่จะลบข้อมูลรายการนี้ ใช่หรือไม่ ???');"><i class='fas fa-user-minus' style='font-size:48px;color:red'></i></a></td>
                  </tr>
    <?php } ?>     
    <?php if($numrow==0){ ?>
   <tr>
    <td colspan="8" align="center" bgcolor="#FFFFCC"><font color="#FF0000">---ไม่มีรายการ---</font></td>
  </tr>
  <?php } ?>
                  </tbody>

...
if(@$_POST['Submit']=="ยืนยัน"){
  $updateSQL ="UPDATE studen SET 
  perfix='".$_POST['perfix']."',
  name_stu='".$_POST['name_stu']."', 
  sur_stu='".$_POST['sur_stu']."',
  tel_stu='".$_POST['tel_stu']."', 
  user='".$_POST['user']."' ,
  pass='".$_POST['pass']."'
	     WHERE id_stu='".$_POST['id_stu']."'";
...
<div class="wrapper">
 ...
 <nav class="main-header navbar navbar-expand navbar- navbar-light">
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
                ...
                <button type="button" class="btn btn-info float-right" onclick="window.location='data.php'"><i class="fa fa-arrow-left"></i> ย้อนกลับ</button>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">แก้ไขข้อมูลนักศึกษา </h3>
    ...
    <?php
   include "connect.php";
   $sql="select*from studen where id_stu='".$_GET['id_stu']."'";
   $query=mysqli_query($conn,$sql);
  ...
  <form id="form1" name="form1" method="post" action="" onsubmit="return check_text()" enctype="multipart/form-data">
        ...
        <!--<tr>
          ...
          <tr>
            ...
            <select name="perfix" id="perfix" class="form-control" >
              <option value="<?php echo $row_Recordset1['perfix'];?>"><?php echo $row_Recordset1['perfix'];?></option>
          ...
          <tr>
            ...
            <td align="left"><input name="name_stu" class="form-control" type="text" id="name_stu" size="50" value="<?php echo $row_Recordset1['name_stu'];?>"/>
           </td>
          </tr>
          <tr>
            <td align="left">สกุล :</td>
            <td align="left"><input name="sur_stu" class="form-control" type="text" id="sur_stu" size="50" value="<?php echo $row_Recordset1['sur_stu'];?>"/>
            </td>
          </tr>
          <tr>
            <td align="left">เบอร์โทร :</td>
           <td align="left"><input name="tel_stu" type="text" minlength="10" maxlength="10" id="tel_stu" class="form-control" size="50" maxlength="10" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" value="<?php echo $row_Recordset1['tel_stu'];?>"/>
            </td>
          </tr>
          <tr>
            <td align="left">ชื่อผู้ใช้ :</td>
            <td align="left"><input name="user" type="text" minlength="6" maxlength="12" id="user" size="50" class="form-control" value="<?php echo $row_Recordset1['user'];?>" />
           </td>
          </tr>
          <tr>
            <td align="left">รหัสผ่าน :</td>
            <td align="left"><input name="pass" type="password" minlength="6" maxlength="12" id="pass" size="50" class="form-control" value="<?php echo $row_Recordset1['pass'];?>" />
           </td>
          </tr>
          <tr>
            <td colspan="2" align="center"><br>
            <input type="hidden" name="id_stu" value="<?php echo $row_Recordset1['id_stu']; ?>" />

   ...
   <nav class="main-header navbar navbar-expand navbar- navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="executive.php" class="nav-link">Home</a>
      </li>
     <!-- <li class="nav-item d-none d-sm-inline-block">
    ...
    include "connect.php";
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
             ...
             <!-- <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="student_ex.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            <a href="volunteer_ex.php" class="nav-link active">
              <i class="nav-icon fas fa-edit"></i>
              <p>
              ตรวจสอบกิจกรรม
              </p>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>ข้อมูลการเข้าร่วมกิจกรรมจิตอาสา</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">แสดงข้อมูลการเข้าร่วมกิจกรรมจิตอาสา </h3>
          ...
          <td ><div align="center">ตรวจสอบ<div></td>
                  </tr>
                  </thead>
                  <tbody>
    <?php
    ...
    include "connect.php";
    @$sql="select*, COUNT('join_activities.id_p') as `items_total` FROM join_activities left join project_participation on join_activities.id_p=project_participation.id_p GROUP BY join_activities.id_p";
		$query=mysqli_query($conn,$sql);
		...
		?>        
                  <tr>
                    ...
                    <td align="center" class="align-middle"><?php
 echo  duration($result['join_time'],$result['end_time']);
 ?>
                    </td>
                    <td align="center" class="align-middle"><a href="student_ex.php?id_p=<?php echo $result['id_p']?>"><button class="btn btn-info"><?php echo $result['items_total']?> คน <i class='fas fa-eye'></i></button></a></td>
                    <td align="center" class="align-middle"> 
                    <form action='check.php?id_p=<?php echo $result['id_p'] ?>' method='post'>
        <select name='status'  onchange='this.form.submit()' >
           <option value='1' <?php if($result['statu_j']=="1"){echo"selected";}?>>-เลือก-</option>
           <option value='2' <?php if($result['statu_j']=="2"){echo"selected";}?>>อนุมัติ</option> 
           <option value='3' <?php if($result['statu_j']=="3"){echo"selected";}?>>ไม่อนุมัติ</option> 
      	</select>
     </form>
                    </td>

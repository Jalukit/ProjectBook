    ...
    include "connect.php";
		...
		?>        
                  <tr>
                    ...
                    <td align="center" class="align-middle"><a href="detail_du.php?id_p=<?php echo $result['id_p']?>"><button class="btn btn-info float-right">คลิก <i class='fas fa-eye'></i></button></a></td>
...
<?php
 ...
 ?>
                    ...
                    <td align="center" class="align-middle"><a href='delte_practice.php?id_p=<?php echo $result['id_p']?>' onclick="return confirm('คุณต้องการที่จะลบข้อมูลรายการนี้ ใช่หรือไม่ ???');"><i class='fas fa-user-minus' style='font-size:48px;color:red'></i></a></td>
                  </tr>
    <?php } ?>     
    <?php if($numrow==0){ ?>
   <tr>

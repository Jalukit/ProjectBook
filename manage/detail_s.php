  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>จัดการข้อมูลสถิติการลงจิตอาสา </h1>
          </div>
          <div class="col-sm-6">
         <?php 
...
<?php
 ...
 <?php
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <?php
    include "connect.php";
    @$s="select*from  studen where id_stu='".$_GET['id_stu']."'";
    $q=mysqli_query($conn,$s);
	$r=mysqli_fetch_array($q);
		?> 
                <h3 class="card-title">แสดงข้อมูลสถิติการลงจิตอาสา &nbsp;&nbsp;<?php echo $r['perfix']?><?php echo $r['name_stu']?> &nbsp;&nbsp; <?php echo $r['sur_stu']?></h3>
    ...
    function duration($begin,$end){
     ...
     left join studen on join_activities.id_stu=studen.id_stu where join_activities.id_stu='".$_GET['id_stu']."'";
    $query=mysqli_query($conn,$sql);
		...
		?>        
                  <tr>
                    ...
                    <td align="center" class="align-middle"><a href="detail_v.php?id_p=<?php echo $result['id_p']?>&id_stu=<?php echo $result['id_stu']?>"><button class="btn btn-info">คลิก <i class='fas fa-eye'></i></button></a></td>
...
<?php
 ...
 ?>
                   ...
                   <!-- <td align="center" class="align-middle"><a href='edit_practice.php?id_p=<?php echo $result['id_p']?>'><i class='fas fa-user-edit' style='font-size:48px;color:blue'></i></a></td>-->
                    <td align="center" class="align-middle"><a href='delte_join.php?id_j=<?php echo $result['id_j']?>&id_stu=<?php echo $result['id_stu']?>' onclick="return confirm('คุณต้องการที่จะลบข้อมูลรายการนี้ ใช่หรือไม่ ???');"><i class='fas fa-user-minus' style='font-size:48px;color:red'></i></a></td>
                  </tr>
    <?php } ?>     
    <?php if($numrow==0){ ?>
   <tr>

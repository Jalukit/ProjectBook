...
?>
<?php
if(@$_POST['button']=="โพสต์"){
include("connect.php");
$date=date("Y-m-d H:i:s");
@$sql="insert into question (create_ques,question) values ('$date','".$_POST['question']."')";
$query=mysqli_query($conn,$sql);
if($query){
	echo"<script>window.location='borad_user.php'</script>";	
}
}
?>
<!DOCTYPE html>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <h1><font color="#000000">ตั้งกระทู้</font></h1>
        </div>
        <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
            <table width="85%" border="0" cellpadding="4" cellspacing="4" >
              <tr class="text-right">
                <th width="27%" align="center"  scope="col">
                <textarea style="margin-left:150px;" name="question" id="question" cols="45" rows="5" required="required" class="form-control" placeholder="คุณกำลังคิดอะไรอยู่"></textarea></th>
              </tr>
              <tr>
                <td colspan="3" align="center">
                <input type="submit" style="width:100px;margin-left:150px;" class="btn btn-primary" name="button" id="button" value="โพสต์" />
                </td>
              </tr>
            </table>
          </form>

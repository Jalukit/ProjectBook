...
echo"<script>window.location='viewdetail_bi.php?id_ques=$_GET[id_ques]'</script>";	
exit();
}else{
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
               ...
               <!-- <button type="button" class="btn btn-info float-right" onclick="window.location='webboard_bi.php'"><i class="fas fa-user-plus"></i> ย้อนกลับ</button>-->
...
<form action="viewdetail.php?id_ques=<?php echo $_GET["id_ques"];?>&Action=Save" method="post" name="frmMain" id="frmMain" onSubmit="return Check_txt()">
	 <table width="100%" height="116" border="0" align="center" cellpadding="1" cellspacing="1" >
			<tr>
			   ...
			   <td width="124" align="center">แสดงความคิดเห็น : </td>
...
?>
			                      <tr>
			                        <td width="177" align="center">&nbsp;</td>
			                        <td width="124" align="center">ชื่อ: </td>
...
echo "window.location='viewdetail_bi.php?id_ques=$_GET[id_ques]';";
echo "</script>";
}

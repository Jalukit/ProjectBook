...
<div class="wrapper">
 ...
 ?>
                    ...
                    <td align="center" class="align-middle"><a href="student.php?id_p=<?php echo $result['id_p']?>"><button class="btn btn-info"><?php echo $result['items_total']?> คน <i class='fas fa-eye'></i></button></a></td>
                   <!-- <td align="center" class="align-middle"> 
                    <a href='delte_practice.php?id_p=<?php echo $result['id_p']?>' onclick="return confirm('คุณต้องการที่จะลบข้อมูลรายการนี้ ใช่หรือไม่ ???');"><i class='fas fa-user-minus' style='font-size:48px;color:red'></i></a>
                    </td>-->

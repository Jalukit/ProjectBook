    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
          <button type="button" class="btn btn-info float-right" onclick="window.location='join.php'"><i class="fa fa-arrow-left"></i> ย้อนกลับ</button>
    ...
    $query=mysqli_query($conn,$sql);
		...
		?>  
                <table id="example2" class="table table-bordered table-hover">
                  <thead>
                  <tr> 
          <td class="align-middle"><div align="center">ชื่อ-นามสกุล</div></td>
          <td class="align-middle"><div align="center"><?php echo $result['perfix']?><?php echo $result['name_stu']?> &nbsp;&nbsp; <?php echo $result['sur_stu']?></div></td>
                  </tr>
                  <tr> 
          ...
          <td class="align-middle"><div align="center"><img id="img" src="picture/<?php echo $result['situation']?>" alt="" style="width:300px; height:250; border-radius:15px;" /></div></td>
                  </tr>
          ...
          <td class="align-middle"><div align="center"><?php echo $result['join_time']?> ถึง <?php echo $result['end_time']?> น.</div></td>
                  </tr>
                  <tr> 
...
echo "รอการตรวจสอบ";
  ...
  echo"ไม่อนุมัติ";
                ...
                <div class="container">
      <p align="center">
        <a href="print.php?id_p=<?php echo $result['id_p']?>" class="btn btn-info btn-lg">
